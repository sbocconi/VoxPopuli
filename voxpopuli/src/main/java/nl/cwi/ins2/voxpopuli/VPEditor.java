...
public class VPEditor
{
    ...
    public static void main( String[] args )
    {
        ...
        try
        {
            ...
            DataBuilder theDataBuilder = new DataBuilder( args[0], args[1], args[2], args[3],
                    theDataContainer, P );
            ...
            int goodness = u.StrToInt( args[5] );
            ...
            try
            {
                ...
                FileFilter fileFilter = new FileFilter()
                {
                    ...
                    {
                        return file.isFile() &&
                                file.toString().matches( ".*" + prefix + "[0-9][0-9]*" + suffix);
                    }
                };
                ...
                SMILMedia theSMILMedia = new SMILMedia( "_100", args[4], null, null, null, args[2], args[7], true, null, true, P );
                
                theSMILMedia.SetSMILURL( "url", "two", "videolocation", "", "stilllocation", "textlocation", "repository",
                        "RDFLocation", "domainNS", "" + "local", "44", "VP", "intercut", "quality",

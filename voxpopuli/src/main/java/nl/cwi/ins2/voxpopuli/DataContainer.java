...
public class DataContainer {
	...
	public UserModel[] UserModelsArray = null; // List of possible User Models
												// in the repository

	public Opinion[] OpinionsArray = null; // List of possible positions in the
											// repository

	public Topic[] TopicsArray = null; // List of possible positions in the
										// repository

	public Question[] QuestionsArray = null; // List of interviews with data

	public Hashtable<String, Person> Interviewees = null; // List of
															// interviewees

	public Interview[] InterviewsArray = null; // List of interviews with topic
												// and position

	public Hashtable<String, VerbalStatement> Statements = null; // List of all
																	// statements

	public Hashtable<String, String[]> Concepts = null; // List of all concepts

	public Hashtable<String, String[]> Modifiers = null; // List of all
															// modifiers

	public Hashtable<String, String[]> Predicates = null; // List of all predicates

	public Hashtable<String, RelationDescription> Relations = null; // List of
																	// all links

	public Hashtable<String, VideoSegment> Videos = null; // List of all video
															// segments

	public Hashtable<String, AudioSegment> Audios = null; // List of all audio
															// segments

	public Hashtable<String, StillSegment> Images = null; // List of all image
															// segments

	public Hashtable<String, TextSegment> Texts = null; // List of all text
														// segments
	...
	public void AddDataToMedia(String[] Ids, String Description, String InterviewId, String StatementId,
			boolean IsInterview) {

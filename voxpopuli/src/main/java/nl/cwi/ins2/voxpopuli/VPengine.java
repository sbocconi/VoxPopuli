...
public class VPengine {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (!(args[5].equals("L")) && !(args[5].equals("M")) && !(args[5].equals("C")) && !(args[5].equals("R"))
					&& !(args[5].equals("V")) && !(args[5].equals("S")) && !(args[5].equals("A"))) {
				Usage();
			}

			if ((args[5].equals("L") && args.length != 7) || (args[5].equals("M") && args.length != 11)
					|| (args[5].equals("C") && args.length != 7) || (args[5].equals("R") && args.length != 7)
					|| (args[5].equals("V") && args.length != 8) || (args[5].equals("S") && args.length != 6)
			...
			if (args[5].equals("V")) {
				 ...
				 * 
				 * //voxpopuli.PathosProcessInterview(UserType, position,
				 * Attack);
				 * 
				 */
				...
				if (args[5].equals("C")) {
					...
					if (args[5].equals("R")) {
						// Skip the SMIL generation, we are only interested in
						// the
						...
						if (args[5].equals("A")) {
							...
							if (args[5].equals("L")) {
								...
								// Do we have to generate an original file as
								// well?
								if (args[7].equals("O")) {
									orig = true;
								} else if (args[7].equals("NO")) {
